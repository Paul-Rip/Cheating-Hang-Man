...
const string DICTIONARY_FILE = "C:\\Users\\admin\\Downloads\\Cheating-Hang-Man-main\\starterCode\\res\\dictionary2.txt";
const bool SHOW_COUNT = false;  // show # of choices left
...
void playGame(WordGuesser* guessManager) {
    while (guessManager->getGuessesLeft() > 0 && 
        ...
        if (SHOW_COUNT) {
            cout << "words   : " << guessManager->getWords()->size();
        }
